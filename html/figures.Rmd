...
clonalexp_MYC = read.table('/Users/minsookim/Desktop/clonalexpMYC.tsv',header=T,row.names=1,sep='\t')
...
TCGAcorr <- read.table('/Users/minsookim/Desktop/corrTCGA.tsv',header=T,quote='',stringsAsFactors=F)
